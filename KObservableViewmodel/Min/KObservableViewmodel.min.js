...
k.set(f[g],k[f[g]]);else for(g=0,f=Object.keys(c),t=f.length;g<t;g++)k.isObservable(c,f[g])?(k[f[g]]&&k.remove(f[g]),k.addPointer(c,f[g])):k.set(f[g],c[f[g]]);if(l)for(g=0,f=Object.keys(l),t=f.length;g<t;g++)k.isObservable(l,f[g])?(n=function(c){if(l[c.key])l[c.key](c.args)},void 0!==k[f[g]]&&k.remove(f[g]),k.addPointer(l,f[g]),k.addActionListener("addDataListener",n).addActionListener("addDataUpdateListener",n).addActionListener("addDataCreateListener",n).addActionListener("addDataRemoveListener",
